...
module Backend.WsApp (wsApp, State(State), _app, _userState) where
...
import           Common.Command         (Command (Connect, Connected, CreateNewStory, CreateRoom, DestroyRoom, JoinRoom, LeaveRoom, NewStoryCreated, RoomDestroyed, RoomJoined, RoomLeft, Vote, VotingComplete),
                                         parseCommand)
